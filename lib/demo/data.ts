...
export const scenes: Scene[] = [
  ...
  { id: "ecom-pdp-hero-banner", name: "PDP Hero Banner", kind: "lifestyle", hue: "20", surface: { tr: "Geniş yaşam tarzı sahnesi", en: "Wide lifestyle scene" }, mood: { tr: "Sinematik", en: "Cinematic" }, emoji: "🖼️", shots: 0, useCases: ["ecommerce"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/H3x_z4CmPljRSiefhPBTQ.jpg" },
  { id: "ecom-instagram-grid", name: "Instagram Grid Square", kind: "studio", hue: "10", surface: { tr: "Kare kırpma, doğal ışık", en: "Square crop, natural light" }, mood: { tr: "Trend, Instagram", en: "Trendy, Instagram" }, emoji: "📸", shots: 0, useCases: ["instagram", "ecommerce"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/N24MVEWjaOxBVQUuqG5Ww.jpg" },
  ...
  { id: "ecom-unboxing", name: "Unboxing Moment", kind: "lifestyle", hue: "35", surface: { tr: "Paket açma anı", en: "Package opening moment" }, mood: { tr: "Heyecanlı, sıcak", en: "Exciting, warm" }, emoji: "📦", shots: 0, useCases: ["lifestyle", "ecommerce"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/SlejNTvLc2sSDlS0qBKMA.jpg" },
  ...
  { id: "ecom-size-comparison", name: "Size Comparison", kind: "studio", hue: "200", surface: { tr: "Referans nesne ile yan yana", en: "Beside a reference object" }, mood: { tr: "Bilgilendirici", en: "Informative" }, emoji: "📏", shots: 0, useCases: ["ecommerce"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/tFli3DhlAjLUOu_kVQj9X.jpg" },
  { id: "ecom-before-after", name: "Before / After Split", kind: "gradient", hue: "40", surface: { tr: "Bölünmüş ekran karşılaştırma", en: "Split-screen comparison" }, mood: { tr: "Kanıt, sonuç", en: "Proof, result" }, emoji: "🔀", shots: 0, useCases: ["ecommerce"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/lDswe6mBinkwscW6xiWHi.jpg" },
  ...
  { id: "ecom-subscription-box", name: "Subscription Box Reveal", kind: "lifestyle", hue: "20", surface: { tr: "Açılmış kutu + ipek kağıt", en: "Opened box + tissue paper" }, mood: { tr: "Sürpriz anı", en: "Reveal moment" }, emoji: "📬", shots: 0, useCases: ["ecommerce", "instagram"], thumbnail: "https://v3b.fal.media/files/b/0aabc155/1U9VQoIsuhuQZHucFopDm.jpg" },
  ...
  { id: "ecom-back-to-school", name: "Back to School Scene", kind: "gradient", hue: "50", surface: { tr: "Parlak, enerjik kampanya", en: "Bright, energetic campaign" }, mood: { tr: "Okula dönüş", en: "Back-to-school" }, emoji: "🎒", shots: 0, useCases: ["ecommerce", "instagram"], thumbnail: "https://v3b.fal.media/files/b/0aabc156/vHjDusHOgR-POd9I1eHEf.jpg" },
];
